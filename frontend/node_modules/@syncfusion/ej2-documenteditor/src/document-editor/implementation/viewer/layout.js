        ...
        if (paragraph.isEmpty()) {
            ...
            while (line instanceof LineWidget) {
                ...
                if (paragraph.isContainsShapeAlone() && paragraph.height === 0) {
                    this.layoutEmptyLineWidget(paragraph, false, paragraph.childWidgets[0]);
                }
            }
        }
    ...
    Layout.prototype.adjustClientAreaBasedOnTextWrap = function (elementBox, rect) {
        ...
        if (this.isNeedToWrapLeafWidget(ownerPara, elementBox)) {
            ...
            for (var i = 0; i < bodyWidget.floatingElements.length; i++) {
                ...
                var allowOverlap = floatingItem.allowOverlap;
                ...
                var textWrappingBounds = new Rect(floatingItem.x - floatingItem.distanceLeft, floatingItem.y - floatingItem.distanceTop, floatingItem.width + floatingItem.distanceLeft + floatingItem.distanceRight, floatingItem.height + floatingItem.distanceTop + floatingItem.distanceBottom);
                var textWrappingStyle = floatingItem.textWrappingStyle;
                var textWrappingType = floatingItem.textWrappingType;
