                ...
                if (shape instanceof ImageElementBox) {
                    ...
                    for (var i_1 = 0; i_1 < blocks.length; i_1++) {
                        ...
                        if (isZeroShapeHeight && shapeType !== 'StraightConnector') {
                            shape.height += blocks[i_1].height;
                        }
                    }
            ...
            for (var i = 0; i < tableCell.ownerTable.childWidgets.length; i++) {
                ...
                if (cell && cell.columnIndex + cell.cellFormat.columnSpan - 1 === tableCell.columnIndex - 1) {
                    ...
                    if (cell.y + cell.height < tableCell.y) {
                        ...
                        this.renderSingleBorder(border_1.color, tableCell.x - cellLeftMargin - lineWidthInt, cell.y - cell.margin.top, tableCell.x - cellLeftMargin - lineWidthInt, cell.y + tableCell.height + cellBottomMargin, lineWidthInt);
                    }
