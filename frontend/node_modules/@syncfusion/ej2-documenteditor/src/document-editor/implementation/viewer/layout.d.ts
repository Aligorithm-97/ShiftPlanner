...
import { BlockContainer, BlockWidget, BodyWidget, ElementBox, FieldElementBox, HeaderFooterWidget, LineWidget, Page, ParagraphWidget, Rect, TableCellWidget, TableRowWidget, TableWidget, Widget, FootNoteWidget } from './page';
...
export declare class Layout {
    ...
    private checkPreviousParaShapeOverlap;
    /**
